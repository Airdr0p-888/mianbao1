...
// v20260601: 重构版 — ModaDividendTracker 独立分红 + owner=deployer + 尾号定制
const CONTRACT_ABI = [
  {
    "inputs": [
      {
...
// 兼容旧版 CONTRACT_DATA 引用
const CONTRACT_DATA = { ABI: CONTRACT_ABI, BYTECODE: CONTRACT_BYTECODE };
console.log("[contract_data] loaded, bytecode length:", CONTRACT_DATA.BYTECODE.length);
